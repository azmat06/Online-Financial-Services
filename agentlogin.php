		...
		<main id="mainshit" class="form-style">
			<section class="container1">
				...
				<div class="container7">
					<span><i class="fas fa-users" style='font-size: 2vw;color:red;'></i> Sign in as Agent</span>
					<form class="form-style" action="includes/agentlogin.inc.php" method="post">
				...
				<?php if(isset($_GET["error"])){
					...
					}else if($_GET["error"]=="successagent"){
