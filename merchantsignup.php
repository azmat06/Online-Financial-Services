	...
	<section class="main">
		...
		<main id="mainshit" class="form-style">
			<section class="container1">
				<div class="container2">Sign up as Merchant</div>
				<div class="container4">
					<div class="container3">
						<form action="includes/merchantsignup.inc.php" method="post">
							<fieldset>
								...
								<input type="text" value="" class="tbox row4merchant" name="organization" placeholder="Organization name"><br>
								<label>Mobile no.</label>
								<input type="text" value="" class="tbox row3merchant" name="mobile" placeholder="Mobile Number">
								<label>Bank Account no.</label>
								<input type="text" value="" class="tbox row3merchant" name="bankacc" placeholder="Bank Account Number"><br>
