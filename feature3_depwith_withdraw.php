...
//redundant
$sqls="select a.fname, a.lname, a.account_id, d.user_id, d.amount, d.date from (withdraw d inner join agents g on d.agent_id=g.agent_id inner join account a on a.account_id=g.agent_id) where d.user_id=".$_SESSION['accuid'].";";
...
<body>
	...
	<section class="main">
		...
		<main id="mainshit" class="form-style">
			...
			<form action="includes_willremovelater/withdraw.inc.php" method="post">
							<fieldset>
								...
								<input type="submit" class="button1" name="bttn1" value="Withdraw">
							</fieldset>
			...
			<form>
				<fieldset>
					<legend>Withdraw History</legend>
