		...
		<main id="mainshit" class="form-style">
			<section class="container1">
				...
				<div class="container7">
					<span><i class="fas fa-user-tie" style='font-size: 2vw;color:red;'></i> Sign in as Merchant</span>
					<form class="form-style" action="includes/merchantlogin.inc.php" method="post">
				...
				<?php if(isset($_GET["error"])){
					...
					}else if($_GET["error"]=="successmerchant"){
