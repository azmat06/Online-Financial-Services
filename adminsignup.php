	...
	<section class="main">
		...
		<main id="mainshit" class="form-style">
			<section class="container1">
				<div class="container2">Sign up as Admin</div>
					...
					<div class="container3">
						<form action="includes/adminsignup.inc.php" method="post">
							<fieldset>
								...
								<label>Name:</label>
								<input type="text" value="" class="tbox row1" name="fname" placeholder="First">
								...
								<input type="text" value="" class="tbox row3admin" name="mobile" placeholder="Mobile Number">
								<br>
